          ...
          {assignments.map((assignment, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  <div className={`text-sm font-medium ${isActive ? 'text-on-primary-container' : 'text-slate-700'}`}>{assignment.title}</div>
                  ...
                  {submission.grade === null && (
                    <form onSubmit={handleSubmitAssignment} className="mt-6 border-t pt-4">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <button type="submit" disabled={uploading} className="rounded bg-accent px-4 py-2 text-sm font-medium text-white hover:bg-brand-orangeHover disabled:opacity-50">
